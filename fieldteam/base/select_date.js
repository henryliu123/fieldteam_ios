...
(function(){
        ...
        var select_date_page_obj = null;
    
        function select_date_page(){
                var self = this;
                var window_source = 'select_date_page';
                ...
                self.nav_right_btn_click_event = function(e){
                        try{
                                ...
                                Ti.App.Properties.setBool('update_select_date_view_flag',true); 
                                Ti.App.Properties.setString('update_select_date_view_content',_calendar_date_year+'-'+temp_month+'-'+temp_date);                                                             
                                win.close();
                        }catch(err){
        ...
        win.addEventListener('open',function(){
                try{
                        ...
                        if(select_date_page_obj === null){
                                var F = function(){};
                                F.prototype = FieldTeam.prototype;
                                select_date_page.prototype = new F();
                                select_date_page.prototype.constructor = select_date_page;
                                select_date_page_obj = new select_date_page();
                                select_date_page_obj.init();
                        }
                }catch(err){
                        alert(err);
                        return;
        ...
        win.addEventListener('close',function(){
                try{
                        select_date_page_obj.close_window();
                        select_date_page_obj = null;
                        win = null;
                }catch(err){
                        alert(err);
                        return;
